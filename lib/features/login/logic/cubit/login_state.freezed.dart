...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loginLoading,TResult Function( LoginResponseBody loginRB)?  loginSuccess,TResult Function( String apiErrorModel)?  loginError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case LoginLoading() when loginLoading != null:
return loginLoading();case LoginSuccess() when loginSuccess != null:
return loginSuccess(_that.loginRB);case LoginError() when loginError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loginLoading,required TResult Function( LoginResponseBody loginRB)  loginSuccess,required TResult Function( String apiErrorModel)  loginError,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case LoginLoading():
return loginLoading();case LoginSuccess():
return loginSuccess(_that.loginRB);case LoginError():
return loginError(_that.apiErrorModel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loginLoading,TResult? Function( LoginResponseBody loginRB)?  loginSuccess,TResult? Function( String apiErrorModel)?  loginError,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case LoginLoading() when loginLoading != null:
return loginLoading();case LoginSuccess() when loginSuccess != null:
...
class LoginSuccess<T> implements LoginState<T> {
  const LoginSuccess(this.loginRB);
  

 final  LoginResponseBody loginRB;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginSuccess<T>&&(identical(other.loginRB, loginRB) || other.loginRB == loginRB));
}


@override
int get hashCode => Object.hash(runtimeType,loginRB);

@override
String toString() {
  return 'LoginState<$T>.loginSuccess(loginRB: $loginRB)';
}
...
/// Create a copy of LoginState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? loginRB = null,}) {
  return _then(LoginSuccess<T>(
null == loginRB ? _self.loginRB : loginRB // ignore: cast_nullable_to_non_nullable
