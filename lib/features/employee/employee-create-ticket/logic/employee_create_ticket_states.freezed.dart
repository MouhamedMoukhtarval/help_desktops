...
part of 'employee_create_ticket_states.dart';
...
/// @nodoc
mixin _$EmployeeCreateTicketStates {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EmployeeCreateTicketStates);
}
...
@override
String toString() {
  return 'EmployeeCreateTicketStates()';
}
...
/// @nodoc
class $EmployeeCreateTicketStatesCopyWith<$Res>  {
$EmployeeCreateTicketStatesCopyWith(EmployeeCreateTicketStates _, $Res Function(EmployeeCreateTicketStates) __);
}


/// Adds pattern-matching-related methods to [EmployeeCreateTicketStates].
extension EmployeeCreateTicketStatesPatterns on EmployeeCreateTicketStates {
...
class _Initial implements EmployeeCreateTicketStates {
  const _Initial();
...
@override
String toString() {
  return 'EmployeeCreateTicketStates.initial()';
}
...
class Loading implements EmployeeCreateTicketStates {
  const Loading();
...
@override
String toString() {
  return 'EmployeeCreateTicketStates.loading()';
}
...
class Success implements EmployeeCreateTicketStates {
  const Success(this.message);
  

 final  String message;

/// Create a copy of EmployeeCreateTicketStates
...
@override
String toString() {
  return 'EmployeeCreateTicketStates.success(message: $message)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $EmployeeCreateTicketStatesCopyWith<$Res> {
...
class Error implements EmployeeCreateTicketStates {
...
@override
String toString() {
  return 'EmployeeCreateTicketStates.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $EmployeeCreateTicketStatesCopyWith<$Res> {
