...
class _TicketService implements TicketService {
  ...
  @override
  Future<List<TicketResponse>> getTechnicianDashboard() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<TicketResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/tickets/technicien/dashboard/',
    ...
    late List<TicketResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => TicketResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
