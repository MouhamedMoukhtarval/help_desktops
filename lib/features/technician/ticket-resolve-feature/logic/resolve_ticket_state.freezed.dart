...
part of 'resolve_ticket_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResolveTicketState);
}
...
/// @nodoc
class $ResolveTicketStateCopyWith<$Res>  {
$ResolveTicketStateCopyWith(ResolveTicketState _, $Res Function(ResolveTicketState) __);
}


/// Adds pattern-matching-related methods to [ResolveTicketState].
extension ResolveTicketStatePatterns on ResolveTicketState {
...
class _Initial implements ResolveTicketState {
  const _Initial();
...
@override
String toString() {
  return 'ResolveTicketState.initial()';
}
...
class Loading implements ResolveTicketState {
  const Loading();
...
@override
String toString() {
  return 'ResolveTicketState.loading()';
}
...
class Success implements ResolveTicketState {
  const Success(this.message);
  

 final  String message;

/// Create a copy of ResolveTicketState
...
@override
String toString() {
  return 'ResolveTicketState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ResolveTicketStateCopyWith<$Res> {
...
class Error implements ResolveTicketState {
...
@override
String toString() {
  return 'ResolveTicketState.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ResolveTicketStateCopyWith<$Res> {
